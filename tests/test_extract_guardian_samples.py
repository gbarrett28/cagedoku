...
def test_is_num_contour_rejects_degenerate_split_sliver():
...
def test_is_num_contour_rejects_merged_two_digit_glyph():
...
def test_select_digit_blobs_returns_exact_match_unchanged():
    blobs = [(14, 8, 16, 37), (35, 8, 27, 37)]
    assert select_digit_blobs(blobs, ndigits=2) == blobs


def test_select_digit_blobs_drops_lower_decoration_fragment():
...
def test_select_digit_blobs_resorts_by_x_after_picking_topmost():
...
def test_select_digit_blobs_returns_none_when_too_few():
